...
/*! LightWave scene model format.
 * \ingroup Model
 *
 * Imports the joint hierarchy from a LightWave scene (.lws) file as a
 * jointed (geometry-less) model; consumed by SkeletonPipeline via ModelCache.
 */
class T_DLLCLASS ModelFormatLws : public ModelFormat
{
	T_RTTI_CLASS;
